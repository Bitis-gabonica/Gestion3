 ...
 */
final class Version20241103191053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id SERIAL NOT NULL, utilisateur_id INT DEFAULT NULL, surname VARCHAR(25) NOT NULL, telephone VARCHAR(11) NOT NULL, adresse TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE dette (id SERIAL NOT NULL, client_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, montant_verse DOUBLE PRECISION NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, statut VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
